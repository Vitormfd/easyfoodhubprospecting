...
import { runSearchAction, detectBatchAction, initialSearchState } from "./actions";
          ...
          <form action={formAction} className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="city" name="city" defaultValue={defaultCity} placeholder="Senhor do Bonfim" required />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                {SEGMENTS.map((segment) => (
                  ...
                  >
                    <Checkbox name="segments" value={segment} defaultChecked={defaultSegments.includes(segment)} />
                    {segment}
                  </label>
                ))}
              </div>
